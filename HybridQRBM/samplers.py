...
class Sampler:
    ...
    def infer(self, visible: npt.NDArray):
        ...
        """
        prob_hidden = self._sigmoid(visible @ self.rbm.weights_ + self.rbm.biases_hidden)
    ...
    def generate(self, hidden: npt.NDArray):
        ...
        """
        prob_visible = self._sigmoid(hidden @ self.rbm.weights_.T + self.rbm.biases_visible)
